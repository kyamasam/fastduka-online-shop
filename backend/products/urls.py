...
from products.views import CategoryViewSet, CategoryTypeViewSet, ProductVariantPhotoViewSet, ProductPhotoViewSet, ProductVariantViewSet, \
    ProductViewSet, ReviewViewSet, TaxViewSet, BrandViewSet, CollectionViewSet

core_router = DefaultRouter()

core_router.register(r"tax-rate", TaxViewSet, basename="tax-rate")
...
core_router.register(r"brand", BrandViewSet, basename="brand")
core_router.register(r"collection", CollectionViewSet, basename="collection")
